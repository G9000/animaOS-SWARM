...
export const SendIcon = (p: IconProps) => base(p, <path d="M12 19V5M5 12l7-7 7 7" />);
...
export const TrashIcon = (p: IconProps) =>
  base(p, <path d="M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m3 0v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6" />);
export const SparkIcon = (p: IconProps) =>
  base(p, <path d="M12 3v3m0 12v3M5.6 5.6l2.2 2.2m8.4 8.4 2.2 2.2M3 12h3m12 0h3M5.6 18.4l2.2-2.2m8.4-8.4 2.2-2.2" />);
export const PulseIcon = (p: IconProps) =>
  base(p, <path d="M22 12h-4l-3 9L9 3l-3 9H2" />);
export const BoltIcon = (p: IconProps) => base(p, <path d="M13 2 3 14h7l-1 8 10-12h-7l1-8z" />);
