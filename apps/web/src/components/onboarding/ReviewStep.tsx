    ...
    <section aria-labelledby="onboarding-review-heading" className="space-y-5">
      ...
      {showActions && (
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            type="button"
            className="rounded-xl bg-accent px-5 py-2 text-sm font-semibold text-accent-fg shadow-lg shadow-accent/20 transition hover:bg-accent/90 disabled:opacity-60 disabled:shadow-none"
            onClick={onSubmit}
            disabled={creating}
          >
            {creating
